<template>
	<div style="height: 100%;">
		...
		<el-main :style='"vertical" == "vertical" ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<index-header :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3020)","padding":"8px 20px","alignItems":"center","background":"#A2CDE0","display":"flex","width":"100%","position":"relative","justifyContent":"center","zIndex":"1"}'></index-header>
