		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"#fff","alignItems":"center","textAlign":"center","display":"flex","width":"60px","fontSize":"18px","justifyContent":"center","height":"100%"}' class="el-icon-menu el-icon-s-home" />
					<span :style='{"width":"calc(100% - 60px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>系统首页</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"#fff","alignItems":"center","textAlign":"center","display":"flex","width":"60px","fontSize":"18px","justifyContent":"center","height":"100%"}' class="el-icon-menu el-icon-user-solid" />
						<span :style='{"width":"calc(100% - 60px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>个人中心</span>
					</template>
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 3px","color":"#fff","alignItems":"center","textAlign":"center","display":"flex","width":"60px","fontSize":"18px","justifyContent":"center","height":"100%"}' class="el-icon-menu" :class="icons[index]" />
						<span :style='{"width":"calc(100% - 60px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>{{ menu.menu }}</span>
					</template>
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #333;
				  				  white-space: nowrap;
				  				  background: linear-gradient(270deg, #fff 0%, #fff 66%, #000 66%, #000 100%);
				  				  display: flex;
